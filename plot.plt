...
set angles radians
# unset grid
set grid xtics ytics lw 2 lt 0
set grid mxtics #lc rgb "#FF0000" lw 1 lt 0
set raxis
set key title ""
...
GNUTERM = "windows"
plot "plot0.dat" using 3:6 with linespoints, "plot1.dat" using 3:6 with linespoints, "plot2.dat" using 3:6 with linespoints, "plot3.dat" using 3:6 with linespoints
pause -1 "Exit!"
#    EOF
